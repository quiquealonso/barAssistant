...
@Component({
  ...
  imports: [TableModule, CommonModule, InputTextModule, DialogModule, FormsModule, Button, Dialog, Picktable, DataView, Tag],
...
infoProduct(product: ProductType) {
  console.log("infoProduct", product.name);
}
